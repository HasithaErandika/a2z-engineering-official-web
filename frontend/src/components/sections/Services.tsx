    ...
    <section className="py-20 lg:py-32 bg-slate-50 border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h3 className="text-3xl lg:text-4xl font-extrabold text-slate-900 mb-6 tracking-tight">Our Key Services</h3>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:border-brand-lightblue/30 transition-all group">
              <div className="w-14 h-14 rounded-xl bg-slate-50 flex items-center justify-center mb-6 shadow-sm border border-slate-100 group-hover:-translate-y-1 transition-transform">
                {service.icon}
              </div>
