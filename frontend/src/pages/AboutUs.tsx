    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <section className="relative bg-gradient-to-br from-slate-50 to-white pt-16 pb-16 border-b border-slate-100 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
           <div className="flex flex-col">
              ...
              <h1 className="text-4xl md:text-5xl font-extrabold mb-6 text-brand-dark tracking-tight">About Us</h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          <div className="aspect-[4/5] bg-slate-50 overflow-hidden relative border border-slate-100 rounded-2xl shadow-sm flex items-center justify-center">
             <span className="text-slate-400 font-bold uppercase tracking-widest text-xs">[Building_1 Graphic Placeholder]</span>
          </div>
          <div className="pt-4">
            <h2 className="text-3xl font-extrabold mb-8 text-slate-900 tracking-tight">Our Story</h2>
            ...
            <blockquote className="mt-10 border-l-4 border-brand-green pl-6 py-2">
              <p className="text-xl font-bold text-brand-dark italic tracking-tight leading-snug">
      ...
      <section className="bg-slate-50 py-20 border-y border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid md:grid-cols-2 gap-8">
           <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100">
              ...
              <h3 className="text-xl font-extrabold text-brand-dark mb-4 tracking-tight uppercase tracking-widest text-sm text-[12px]">Our Vision</h3>
           ...
           <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100">
              ...
              <h3 className="text-xl font-extrabold text-brand-dark mb-4 tracking-tight uppercase tracking-widest text-sm text-[12px]">Our Mission</h3>
              <p className="text-slate-600 leading-relaxed text-sm">
      ...
      <section className="bg-brand-dark text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center mb-16">
              <h3 className="text-3xl md:text-4xl font-extrabold tracking-tight mb-4">Our Leadership</h3>
           ...
           <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 flex items-center gap-6">
                 <div className="w-16 h-16 bg-brand-blue rounded-full flex shrink-0 items-center justify-center text-xl font-bold border-2 border-brand-green/30">
                    IW
                 </div>
                 <div>
                    <h4 className="text-xl font-bold tracking-tight mb-1">Indika Wickramasinghe</h4>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-8 flex items-center gap-6">
                 ...
                 <div>
                    <h4 className="text-xl font-bold tracking-tight mb-1">Dhammika Chandrasiri</h4>
           ...
           <div className="mt-20 text-center">
              <h4 className="text-3xl lg:text-5xl font-extrabold text-white tracking-tighter">
