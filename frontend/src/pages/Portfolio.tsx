    ...
    <div className="min-h-screen bg-white text-slate-900 flex flex-col">
      ...
      <section className="relative bg-gradient-to-br from-slate-50 to-white pt-16 pb-16 border-b border-slate-100 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full pointer-events-none z-0">
          ...
          <svg viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg" className="absolute top-7 right-20 w-[250px] h-[250px] opacity-[0.25]">
      ...
      <section className="bg-brand-dark py-12 text-white overflow-hidden relative">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap items-center gap-6 lg:gap-16 relative z-10">
            <div className="flex flex-col">
               <span className="text-sm font-bold text-brand-green uppercase tracking-widest mb-2">Total Capacity</span>
               <span className="text-3xl lg:text-4xl font-black tracking-tight">3,752.58 <span className="text-base font-bold opacity-50">kW</span></span>
            </div>
            <div className="w-px h-12 bg-white/10 hidden md:block" />
            <div className="flex flex-col">
               <span className="text-sm font-bold text-brand-green uppercase tracking-widest mb-2">Total Projects</span>
               <span className="text-3xl lg:text-4xl font-black tracking-tight">384</span>
            </div>
            <div className="w-px h-12 bg-white/10 hidden md:block" />
             <div className="flex flex-col">
               <span className="text-sm font-bold text-brand-green uppercase tracking-widest mb-2">Connected Infrastructure</span>
               <span className="text-3xl lg:text-4xl font-black tracking-tight">1.6 <span className="text-base font-bold opacity-50">MW+</span></span>
            </div>
         </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full flex-grow">
        ...
        <div className="mb-16">
           ...
           <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-7 rounded-lg shadow-sm border border-slate-100 flex flex-col justify-between">
                 <div>
                    <h4 className="text-lg font-bold text-brand-dark mb-4 uppercase tracking-widest text-[11px]">Division 01</h4>
                    <h5 className="text-lg font-extrabold mb-4 text-slate-900 leading-tight">Residential Solar Solutions</h5>
              ...
              <div className="bg-white p-7 rounded-lg shadow-sm border border-slate-100 flex flex-col justify-between">
                 <div>
                    ...
                    <h5 className="text-lg font-extrabold mb-4 text-slate-900 leading-tight">Commercial Installations</h5>
              ...
              <div className="bg-white p-7 rounded-lg shadow-sm border border-slate-100 flex flex-col justify-between">
                 <div>
                    ...
                    <h5 className="text-lg font-extrabold mb-4 text-slate-900 leading-tight">Grid-Tied Infrastructure</h5>
        ...
        <div className="mb-12">
            <h3 className="text-2xl font-extrabold text-slate-900 mb-10 tracking-tight">Featured Large-Scale Projects</h3>
            <div className="grid md:grid-cols-3 gap-6">
               {projects.map((proj, i) => (
                  <div key={i} className="bg-white border flex flex-col border-slate-100 rounded-lg overflow-hidden shadow-sm group">
                     <div className="aspect-[4/3] relative overflow-hidden border-b border-slate-100">
                        <img 
                          src={i === 0 ? "/images/facility-preview.png" : i === 1 ? "/images/building-office.png" : "/images/solar-panel-product.png"} 
                          alt={proj.title}
                          className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" 
                        />
                        <div className="absolute top-4 right-4 bg-brand-green text-white font-bold text-[10px] px-4 py-1.5 rounded-full shadow-sm z-10">
                           {proj.capacity}
                        </div>
                     </div>
                     <div className="p-7 flex flex-col flex-grow">
                        <p className="text-brand-blue font-bold text-[10px] uppercase tracking-widest mb-3">{proj.title}</p>
                        <h4 className="text-xl font-extrabold text-slate-900 mb-4 tracking-tight leading-tight group-hover:text-brand-dark transition-colors">{proj.location}</h4>
